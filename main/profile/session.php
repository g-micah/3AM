...
$query = "SELECT USR_username, USR_color, USR_image, USR_email, USR_phone, USR_cert, USR_Cat, USR_Bio from USER where USR_username = '$user_check'";
...
$login_pic = $row['USR_image'];
$login_email = $row['USR_email'];
$login_phone = $row['USR_phone'];
$login_cert = $row['USR_cert'];
$login_Cat = $row['USR_Cat'];
$login_Bio = $row['USR_Bio'];
